      ...
      const fetchData = async () => {
        try {
          ...
          if (voiture != null && voiture.length > 0) {
            const acceptUrl = `http://finalprojectcar-production-aab1.up.railway.app/api/admin/insertAcceptAnnonce?id_user=${voiture[0].idUtilisateur}&id_voiture=${voiture[0].idVoiture}`;
